...
public final class DependencyLink implements Serializable {
    ...
    public DependencyLink.Builder toBuilder() {
        return new DependencyLink.Builder(this);
    }

    public static DependencyLink.Builder builder() {
        return new DependencyLink.Builder();
    }
    ...
    public String toString() {
        return new String(com.nike.wingtips.zipkin.elasticapm.Codec.JSON.writeDependencyLink(this), UTF_8);
    }
    ...
    final Object writeReplace() throws ObjectStreamException {
        return new DependencyLink.SerializedForm(com.nike.wingtips.zipkin.elasticapm.Codec.THRIFT.writeDependencyLink(this));
    }
